    ...
    return (
        <div className='flex flex-col md:flex-row justify-around items-center py-10'>
            <img className='h-[500px] rounded-[50%]'
                src={require("../assets/PricingImage.jpg")} alt="PricingImage" />
            <div className='w-96 shadow-xl rounded-xl p-4'>
                ...
                <button className='bg-black font-bold text-white py-1.5 px-4 mt-8'>
                    Book Now
                </button>
            </div>
        </div>
